...
### 7. Habilitar Economia de Energia
Ativa o sistema de gerenciamento de energia (light sleep entre leituras).
...
**Efeito:** Reduz consumo em até 98% nos intervalos entre leituras.

---

### 8. Desabilitar Economia de Energia
Desativa o gerenciamento de energia (útil para debug).
...
### 9. Alterar Modo de Economia
Define como o sistema gerencia energia.
...
```
*Sleep automático se período ≥ 1 minuto*

**Modo Light Sleep (sempre):**
```json
{
  "command": "set_power_mode",
  "mode": "light_sleep"
...
```
*Sempre usa sleep, máxima economia*

**Modo Normal (sem sleep):**
```json
{
  "command": "set_power_mode",
  "mode": "normal"
...
```
*Sem economia, máxima responsividade*

---

### 10. Estatísticas de Energia
Mostra estatísticas de uso do power management (nos logs serial).
...
**Resposta:** Logs com total de sleeps, tempo dormindo, wake-ups, etc.
